...
LICOR_FILES_TO_PROCESS <- c(
    '2023-11-16 sugarcane aci 2 ripe 6.xlsx',
    '2023-11-16 sugarcane aci ripe 1.xlsx',
    '2023-11-16 sugarcane aci ripe 2.xlsx',
    '2023-11-16 sugarcane aci ripe 4.xlsx',
    '2023-11-16 sugarcane aci ripe 6.xlsx',
    '2023-11-16 sugarcane aci ripe 9.xlsx',
    '2023-11-17 sugarcane aci ripe 1.xlsx',
    '2023-11-17 sugarcane aci ripe 2.xlsx',
    '2023-11-17 sugarcane aci ripe 4.xlsx',
    '2023-11-17 sugarcane aci ripe 9.xlsx'
)

# Specify which measurement numbers to choose. Here, the numbers refer to
# points along the sequence of A-Ci measurements.
NUM_OBS_IN_SEQ <- 14
MEASUREMENT_NUMBERS_TO_REMOVE <- 7
...
# Perform A-Ci fits, excluding  few curves where good fits cannot be obtained
...
fit_result <- consolidate(by(
    data_for_fits,
    data_for_fits[, UNIQUE_ID_COLUMN_NAME],
    fit_c4_aci,
    OPTIM_FUN = solver,
    Ca_atmospheric = 420,
    alpha = 0,
