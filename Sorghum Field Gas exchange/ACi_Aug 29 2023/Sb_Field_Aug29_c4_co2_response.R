...
if (packageVersion('PhotoGEA') != '0.11.0') {
    stop(
        'The `Sb_Field_Aug29_c4_co2_response.R` script requires PhotoGEA ',
...
LICOR_FILES_TO_PROCESS <- c(
    ...
    '2023-08-29 cs sorghum aci ripe 8.xlsx',
    '2023-08-31 cs sorghum aci ripe 14.xlsx',
    '2023-08-31 cs sorghum aci ripe 5.xlsx',
    '2023-08-31 cs sorghum aci ripe 6.xlsx',
    '2023-08-31 cs sorghum aci ripe 8.xlsx'
)
...
NUM_OBS_IN_SEQ <- 14
MEASUREMENT_NUMBERS_TO_REMOVE <- c(8, 9, 14)
