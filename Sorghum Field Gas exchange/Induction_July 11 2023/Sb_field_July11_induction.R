...
if (packageVersion('PhotoGEA') != '0.11.0') {
    stop(
        'The `Sb_field_July11_induction.R` script requires PhotoGEA version ',
...
LICOR_FILES_TO_PROCESS <- c(
    '2023-07-11 cs sorghum cabbi.xlsx',
    '2023-07-11 cs sorghum rogue.xlsx',
    '2023-07-11 sorghum ripe 2.xlsx',
    '2023-07-11 sorghum ripe 3.xlsx'
)
