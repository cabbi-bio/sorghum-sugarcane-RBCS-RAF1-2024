...
if (packageVersion('PhotoGEA') != '0.11.0') {
    stop(
        'The `Sb_Field_Aug4_c4_co2_response.R` script requires PhotoGEA ',
...
LICOR_FILES_TO_PROCESS <- c(
    '2023-08-04 cs aci sorghum ripe 10.xlsx',
    '2023-08-04 cs sorghum aci ripe 5.xlsx',
    '2023-08-04 cs sorghum aci ripe 8.xlsx'
)
