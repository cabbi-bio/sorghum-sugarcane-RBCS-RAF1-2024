...
if (packageVersion('PhotoGEA') != '0.11.0') {
    stop(
        'The `Sb_GH_c4_co2_response.R` script requires PhotoGEA ',
...
LICOR_FILES_TO_PROCESS <- c(
    '2023-01-24 cs sorghum T2 aci ripe 8.xlsx',
    '2023-01-24 sorghum T2 aci ripe 4.xlsx',
    '2023-01-24 sorghum T2 aci ripe 5.xlsx',
    '2023-01-24 sorghum T2 aci ripe 7.xlsx',
    '2023-01-26 cs t2 sorghum aci ripe 4.xlsx',
    '2023-01-26 cs t2 sorghum aci ripe 5.xlsx',
    '2023-01-26 cs t2 sorghum aci ripe 7.xlsx',
    '2023-01-26 cs t2 sorghum aci ripe 8.xlsx'
)
