...
if (packageVersion('PhotoGEA') != '0.11.0') {
    stop(
        'The `Sb_greenhouse_induction.R` script requires PhotoGEA ',
...
LICOR_FILES_TO_PROCESS <- c(
    '2023-01-25 cs sorghum t2 induction ripe 4.xlsx',
    '2023-01-25 cs sorghum t2 induction ripe 5.xlsx',
    '2023-01-25 cs sorghum t2 induction ripe 7.xlsx',
    '2023-01-25 cs t2 sorghum induction ripe 8.xlsx',
    '2023-01-26 cs t2 sorghum induction ripe 4.xlsx',
    '2023-01-26 cs t2 sorghum induction ripe 5.xlsx',
    '2023-01-26 cs t2 sorghum induction ripe 7.xlsx',
    '2023-01-26 cs t2 sorghum induction ripe 8.xlsx'
)
